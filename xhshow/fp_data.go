...
var (
	...
	ScreenResolutions = struct {
		...
		Resolutions: []string{"1366;768", "1600;900", "1920;1080", "2560;1440", "3840;2160", "7680;4320"},
		Weights:     []float64{0.25, 0.15, 0.35, 0.15, 0.08, 0.02},
	}

	ColorDepthOptions = struct {
		Values  []int
		Weights []float64
	}{
		Values:  []int{16, 24, 30, 32},
		Weights: []float64{0.05, 0.6, 0.05, 0.3},
	}

	DeviceMemoryOptions = struct {
		Values  []int
		Weights []float64
	}{
		Values:  []int{1, 2, 4, 8, 12, 16},
		Weights: []float64{0.10, 0.25, 0.4, 0.2, 0.03, 0.01},
	}
	...
	CoreOptions = struct {
		...
		Values:  []int{2, 4, 6, 8, 12, 16, 24, 32},
		Weights: []float64{0.1, 0.4, 0.2, 0.15, 0.08, 0.04, 0.02, 0.01},
	}
)
...
const (
	...
	CanvasHash       = "742cc32c"
	VoiceHashOptions = "10311144241322244122"
